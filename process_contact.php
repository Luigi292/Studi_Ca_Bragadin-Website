...
define('GMAIL_PASS', 'bbfd brrw eaem efsq');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Define professional recipients
        $recipients = [
            'avv_lenzi' => [
            ...
            'dott_maretto' => [
                'email' => 'maretto88@gmail.com', // This is now correctly set
        ...
        $mail->Body = "<h2>Nuova richiesta di contatto</h2>
            ...
            <p><strong>Professionista selezionato:</strong> {$recipient['name']}</p>
        ...
        $mail->AltBody = "Nuova richiesta di contatto\n\n" .
            ...
            "Professionista selezionato: {$recipient['name']}\n" .
            "Servizio: {$service}\n\n" .
            "Messaggio:\n{$message}\n\n" .
        ...
        echo json_encode([
            'success' => true,
            'message' => "Grazie {$firstName} {$lastName}! La tua richiesta è stata inviata a {$recipient['name']}. Ti contatteremo al più presto."
        ]);
